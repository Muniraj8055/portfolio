        ...
        <div className='flex items-center justify-between'>
            <div className='mx-7'>
                <h4 className='text-4xl uppercase font-bold'>
                    Muni<span className='text-cyan-600'>Raj</span>
                </h4>
            </div>
            ...
            <div className={`md:hidden text-black absolute w-2/3 h-screen px-7 py-2 font-medium
             bg-white opacity-75 top-0 duration-500 ${ open ? "right-0" : "right-[-100%]"}`}>
